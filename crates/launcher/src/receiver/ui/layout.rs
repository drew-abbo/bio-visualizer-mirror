...
fn search_bar(ui: &mut Ui, state: &mut LayoutState) {
    TopBottomPanel::top("top_panel").show(ui.ctx(), |ui| {
        ui.style_mut().visuals.override_text_color = Some(Color32::from_rgb(0x72, 0x02, 0x57)); // #720257
        ...
        let name_input = ui
            .scope(|ui| {
                ...
                ui.visuals_mut().widgets.inactive.bg_stroke =
                    Stroke::new(2.0, Color32::from_rgb(0xFE, 0x71, 0xD0));
                // #FE71D0
                ...
                ui.style_mut().visuals.override_text_color =
                    Some(Color32::from_rgb(0xFE, 0x71, 0xD0));              // #FE71D0
                ...
                //     outer.response_rect,
                //     3.0,
                //     Stroke::new(1.5, egui::Color32::GREEN),
                // )
            })
            .inner;
